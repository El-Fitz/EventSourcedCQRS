...
export const testSuites: TestSuite[] = [
	(() => {
		...
		return {
			title: 'Agggregates - Repositories Repository - Succesfully initializes Projections Repositories Repository',
			expectedResult: null,
	...
	(() => {
		...
		return {
			title: 'Agggregates - Repositories Repository - Projections Repositories Repository has the proper methods',
			expectedResult: null,
			initialState: undefined,
			parameters: undefined,
			implementation,
