 ...
 * @Last Modified time: 2021-06-26 19:23:47
 */

import test from 'ava';
import Platform from "../../../../../../src/index.js"

test('Succesfully initializes Event Reducers Definitions Service', t => {
	let service = Platform.Events.Reducers.Definitions.Service()
	t.not(service, undefined);
});

test('Event Reducers Definitions Service has the proper methods', t => {
	let service = Platform.Events.Reducers.Definitions.Service()
